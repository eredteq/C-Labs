...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	// Розміри вікна згідно з варіантом 8 - 450 на 440 піксельів, розташування вікна по правому краю екрана.
	int windowWidth = 450;
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
	{
		...
		// Робимо фон тексту прозоримим, щоб не було білого прямокутника
